...
import { Bot, User, Send, Loader2, ChevronDown, FileCode, ChevronRight, X } from "lucide-react";
import { askAgent, listRepositories, peekFileLines, type AgentSource } from "@/lib/api";
...
export default function AgentPage() {
  ...
  const send = async () => {
    ...
    try {
      const res = await askAgent({ question, repo_id: selectedRepo || undefined });
      setMessages((m) => [
        ...m,
