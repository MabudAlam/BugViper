...
class ScalaLangTreeSitterParser:
            ...
            if "variables" in SCALA_QUERIES:
                try:
                    results = execute_query(
                        self.language, SCALA_QUERIES["variables"], tree.root_node
                    )
                ...
                try:
                    ...
                    if name_node:
                        ...
                        func_data = {
                            ...
                            if context_type
                            and "class" in str(context_type)
                            or "object" in str(context_type)
                            or "trait" in str(context_type)
                            else None,
                        }
                ...
                try:
                    ...
                    if name_node:
                        ...
                        for child in node.children:
                            ...
                            ):  # Might vary by grammar version: 'extends' keyword + types
                        ...
                        if extends_clause:
                            for child in extends_clause.children:
                                if (
                                    child.type == "type_identifier" or child.type == "user_type"
                                ):  # specific to scala grammar
            ...
            if capture_name == "name":
                ...
                if node.parent.type in ("val_definition", "var_definition"):
                    ...
                    if type_node:
                        ...
                        if val_node:
                            if (
                                val_node.type == "instance_expression"
                                or val_node.type == "new_expression"
                            ):
                                # new Calculator()
                    ...
                    variables.append(
                        {
                            ...
                            if ctx_type and ("class" in str(ctx_type) or "object" in str(ctx_type))
                            else None,
                        }
                    )
    ...
    def _parse_calls(
        self, captures: list, source_code: str, path: Path, variables: List[Dict] = []
    ) -> List[Dict]:
        calls = []
        seen_calls = set()
            ...
            if capture_name == "call_node":
                try:
                    ...
                    if "." in full_name:
                        ...
                        call_name in variables
                    ):  # Usually not happening as variables is list of dicts
                        pass
