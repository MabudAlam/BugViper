...
2. `peek_code` with a SINGLE call using above=200, below=50 to read the FULL source at once. Never call peek_code multiple times on the same function — one large window is enough.
...
**For "what does this project do?" or "what is this project about?" questions:**
1. `get_readme()` to read the README content
2. SUMMARIZE the README in your own words — do NOT dump the raw content. Give a 2-4 sentence overview of what the project is and its main features.
...
- **Summarize README.** When asked "what does this project do?", summarize the README in 2-4 sentences. Do NOT dump raw README content — synthesize and paraphrase.
"""
